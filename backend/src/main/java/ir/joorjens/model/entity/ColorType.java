...
@Entity
@Table(name = "color_type", uniqueConstraints = {
        @UniqueConstraint(columnNames = {"name"}, name = "UK_COLOR_TYPE__name")})
public class ColorType extends AbstractModel {
