...
public class DistributorListByScoreFragment extends Fragment implements ActivityServiceListener{
    ...
    public DistributorListByScoreFragment() {

    }

    public static DistributorListByScoreFragment newInstance(){
        DistributorListByScoreFragment fragment = new DistributorListByScoreFragment();
        return fragment;
    }
    ...
    private void loadDists(){
        ...
        params.put("ordertypeid", EnumHelper.getEnumCode(EnumHelper.AllEnumNames.OrderTypeIdRating)+"");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_distributor_list_by_score, container, false);
        distsLinearLayout = (LinearLayout) v.findViewById(R.id.distlist_container_distributors);
        _tvDistNotFound = (TextViewPlus) v.findViewById(R.id.fr_dis_list_by_score_dist_not_found);

        mMainScroll = (NestedScrollView) v.findViewById(R.id.dist_list_by_score_main_scroll);
        ...
        mRefreshLayout = (SwipeRefreshLayout) v.findViewById(R.id.dist_by_score_refresh);
