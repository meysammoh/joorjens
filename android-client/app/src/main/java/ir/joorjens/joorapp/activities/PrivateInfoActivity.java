...
public class PrivateInfoActivity extends BaseActivity implements ActivityServiceListener {
    ...
    private TextViewPlus _tvPiCredit;

    private FreakyInputBox _fibPersonalId;
    private FreakyInputBox _fibMobileNumber;
    private FreakyInputBox _fibEmail;

    private FreakyInputBox _fibStoreName;
    private FreakyInputBox _fibStoreAddress;
    private FreakyInputBox _fibStorePhone;
    private FreakyInputBox _fibStoreLicence;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.addContentView(R.layout.activity_private_info);

        _imgPiAvatar = (ImageViewPlus) findViewById(R.id.img_pi_avatar);
        _tvPiName = (TextViewPlus) findViewById(R.id.tv_pi_name);
        _tvPiCredit = (TextViewPlus) findViewById(R.id.tv_pi_credit);

        _fibPersonalId = (FreakyInputBox) findViewById(R.id.pi_fib_personal_id);
        _fibMobileNumber = (FreakyInputBox) findViewById(R.id.pi_fib_mobile_number);
        _fibEmail = (FreakyInputBox) findViewById(R.id.pi_fib_email);

        _fibStoreName = (FreakyInputBox) findViewById(R.id.pi_fib_store_name);
        _fibStoreAddress = (FreakyInputBox) findViewById(R.id.pi_fib_store_address);
        _fibStorePhone = (FreakyInputBox) findViewById(R.id.pi_fib_store_phone);
        _fibStoreLicence = (FreakyInputBox) findViewById(R.id.pi_fib_store_licence);
        ...
        _btnApplyChanges = (ButtonPlus) findViewById(R.id.pi_btn_apply_changes);
        _btnApplyChanges.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UserAPIs.changePassword(PrivateInfoActivity.this, Authenticator.loadAuthenticationToken(), params, 0);
            }
        });
        ...
        _tvPiCredit.setText(String.format("%,d", p.getCredit()) + " تومان");
