...
public class ProductPropertiesRow2 extends TableRow {
    TextViewPlus mPropertyTitle;
    TextViewPlus mPropertyValue;
    private LinearLayout mMainLayout;
    public ProductPropertiesRow2(Context context) {
        super(context);
        init(null);
    }

    public ProductPropertiesRow2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    private void init(AttributeSet attrs) {
        View view = inflate(getContext(), R.layout.view_product_properties_row2, null);
