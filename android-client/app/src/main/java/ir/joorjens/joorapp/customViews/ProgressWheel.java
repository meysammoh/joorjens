...
public class ProgressWheel extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        ViewGroup row = (ViewGroup) this.getParent();
        ...
        if(textView!=null) {
            width = textView.getMeasuredWidth() - getPaddingLeft() - getPaddingRight();
            height = textView.getMeasuredHeight()- getPaddingTop() - getPaddingBottom();
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isSpinning) {
            ...
            canvas.drawArc(circleBounds, -89, -progress, false, barPaint);
        }
        //Draw the text (attempts to center it horizontally and vertically)
        float textHeight = textPaint.descent() - textPaint.ascent();
        float verticalTextOffset = (textHeight / 2) - textPaint.descent();

        Typeface fontFace = FontCache.get("fonts/yl.ttf",getContext());
